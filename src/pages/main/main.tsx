...
const TAB_LETTERS = ['a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k', 'l'];
...
const AppWrapper = observer(() => {
    ...
    const handleBotClick = useCallback(
        ...
        [setActiveTab, load_modal, updateWorkspaceName] // eslint-disable-line react-hooks/exhaustive-deps
    );

    const handleOpen = useCallback(async () => {
        await load_modal.loadFileFromRecent();
        setActiveTab(DBOT_TABS.BOT_BUILDER);
    }, [load_modal, setActiveTab]); // eslint-disable-line react-hooks/exhaustive-deps
