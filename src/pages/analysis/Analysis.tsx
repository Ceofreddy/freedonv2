            ...
            if (data.msg_type === 'active_symbols') {
                ...
                volatilitySymbols.forEach(symbol => {
                    ...
                    if (name.includes('jump')) {
                        ...
                        name.includes('vol') ||
                        symbol.market === 'volatility_indices'
                    ) {
                    ...
                    <div className={styles.patternSection}>
                        ...
                        <div className={styles.patternGrid}>
                            {lastDisplayedDigits.map((digit, index) => (
                                <div
                                    key={index}
                                    className={`${styles.patternBox} ${digit % 2 === 0 ? styles.even : styles.odd}`}
                                >
                                    {digit % 2 === 0 ? 'E' : 'O'}
                                </div>
                            ))}
                                ...
                                <div className={styles.digitsGrid}>
                                    {lastDisplayedDigits.map((digit, index) => (
                                        ...
                                        >
                                            ...
                                            {index === lastDisplayedDigits.length - 1 && (
                                                <span className={styles.latestIndicator}>●</span>
                                            )}
                                        </div>
                                    ))}
                                </div>
