...
export default defineConfig({
    ...
    source: {
        ...
        define: {
            'process.env': {
                DERIV_APP_ID: JSON.stringify(process.env.DERIV_APP_ID || '116730'),
                TRANSLATIONS_CDN_URL: JSON.stringify(
                    process.env.TRANSLATIONS_CDN_URL || 'https://translations.deriv.com/fusion'
                ),
                R2_PROJECT_NAME: JSON.stringify(process.env.R2_PROJECT_NAME || 'bot-web'),
                CROWDIN_BRANCH_NAME: JSON.stringify(process.env.CROWDIN_BRANCH_NAME || 'master'),
